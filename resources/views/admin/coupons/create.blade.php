<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Create Coupon') }}</h2>
    </x-slot>
                    ...
                    <form action="{{ route('admin.coupons.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" name="min_purchase" id="min_purchase" value="{{ old('min_purchase') }}" step="0.01" min="0"
